...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public class ViewAdapter extends RecyclerView.ViewHolder {
        ...
        public ViewAdapter(@NonNull View itemView) {
            ...
            profileImg = itemView.findViewById(R.id.image_profile_user);
        }
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        writeNewUser(user.getNameSurname(), user.getService());
        holder.follow.setVisibility(View.VISIBLE);
        holder.nameSurname.setText(mUsers.get(position).getNameSurname());
        holder.service.setText(mUsers.get(position).getService());
        holder.phoneNumber.setText(mUsers.get(position).getPhone());
    ...
    public void writeNewUser(String nameSurname, String service) {
        User user = new User();
        reference =FirebaseDatabase.getInstance().getReference();
        reference.child("users").child("Name Surname").setValue(user);
        reference.child("users").child("Service");
    }
}
